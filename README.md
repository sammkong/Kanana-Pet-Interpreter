 ...
 **<img width="1280" height="720" alt="Image" src="https://github.com/user-attachments/assets/c3264859-1410-427c-bd00-0914a34ef2d0" />**
 ...
 아래 링크로 들어가시면, 실제 서비스 실행 화면입니다. 반려동물의 사진을 올리면 사진을 분석하여 감정을 읽어냅니다.
반려동물의 감정을 기반으로, 사진 속 반려동물의 대사를 구현해 음성으로까지 출력됩니다.

소리를 키고 들으시면, "간절"이라는 감정을 담아 Kanana-o 모델이 반려동물의 대사를 읽어주는 것을 들을 수 있습니다.
...
이 프로젝트에서 가장 흥미로웠던 부분은  
“모델 성능”보다 **AI 응답 경험 품질**이었습니다.

특히 가장 크게 발견한 문제는

> 응답이 길어질수록  
> `~멍!`, `~냥.` 페르소나 consistency가 쉽게 깨진다는 점이었습니다.
